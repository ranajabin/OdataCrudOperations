		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#crudoperationodatacrudoperationsproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"crudoperationodatacrudoperationsproject-display": {
								"semanticObject": "crudoperationodatacrudoperationsproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=crudoperation.odatacrudoperationsproject",
									"url": sap.ui.require.toUrl("crudoperation/odatacrudoperationsproject")
								}
							}
						}
					}
